...
projects. Since Mole allows the programmer to use the file-system as he
...
browse images, models, sounds, etc. Mole is more scene-based in nature
...
It is very often necessary to use asset importing in Mole. As the
...
-  If a team is working on the project, assets can be re-imported by
   other project members, because Mole keeps track of source assets
...
settings screen or the valley. Since everything in Mole is done with
...
Mole uses a hidden file called ".fscache" at the root of the project.
