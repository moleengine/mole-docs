...
Mole does not do the re-import process automatically, though. It gives
...
-  If all else fails, Mole supports adding custom resource loaders,
...
Mole does not mind much about the location, but if the project has
...
sub-folder). Mole expects regular resources in there, and may consider
...
folder, the rule that Mole uses to reference external assets can be
...
Mole provides for importing several types of assets, all of them can be
...
project folders. Once imported, Mole saves this information as metadata
...
Mole tracks changes in the source assets constantly. If at least one
