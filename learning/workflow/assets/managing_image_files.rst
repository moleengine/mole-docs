...
(.png, .jpg, etc.) are treated as regular resources in Mole.
...
When the mipmaps option is enabled, Mole will generate mipmaps.
...
individual flags can be changed. Mole also keeps track of the original
