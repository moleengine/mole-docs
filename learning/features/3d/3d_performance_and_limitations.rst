...
Mole follows a balanced performance philosophy. In performance world,
...
Mole is not an exception and, while it is designed to have backends
...
maximum performance out of Mole.
...
Mole renderer is a little different to what is out there. It's designed
...
Mole's priorities will be like this:
...
Mole offers to compress textures of 3D models when imported (VRAM
...
As mentioned before, Mole sorts objects by material and shader to
...
performance in some cases. Mole has a very simple system to use level
of detail,
