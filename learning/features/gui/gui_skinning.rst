...
Mole user interface uses these kind of controls with the default theme,
...
documentation is the file `scene/resources/default_theme/default_theme.cpp`__.
...
In the inline help of Mole (in the script tab) you can check which theme options
