...
Imagine we have a spaceship somewhere in space. In Mole this is easy,
...
Mole are created with *identity*.
...
Mole has a special type for a 3x3 matrix, named :ref:`Matrix3 <class_Matrix3>`.
...
To add the final component to the mix, Mole provides the
