...
Mole engine has integrated GooglePaymentsV3 module with which we can implement in-app purchases in our game.

The Mole engine demo project repository has an android-iap example project. It includes a moscript interface for android IAP.

Check the repository here https://github.com/moleengine/mole-demo-projects

Find the iap.mo script in

::

    mole-demo-projects/misc/android_iap
...
::
    ...
    func sku_details_complete():
        print(IAP.sku_details) #This will print the details as JSON format, refer the format in iap.mo
