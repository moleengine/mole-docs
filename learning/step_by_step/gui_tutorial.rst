...
During the development of Mole (and previous engine iterations),
...
In the end, the resulting UI subsystem in Mole is an efficient solution
...
Additionally, even though Mole comes with dozens of controls for
...
As mentioned before, Mole includes dozens of controls ready for use
...
-  Creating Mole Editor Plugins, to extend the engine functionality.
