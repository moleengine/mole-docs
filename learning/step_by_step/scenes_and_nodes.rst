...
Making games in Mole feels pretty much the same way. Using the engine
...
In Mole, the ability to arrange nodes in this way creates a powerful
...
Basically, the Mole editor is a **scene editor**. It has plenty of
...
When the mole executable is run outside a project, the Project Manager
...
will open the Mole editor. Here is how the editor looks when freshly
opened:

.. image:: /img/empty_editor.png

As mentioned before, making games in Mole feels like being in a
...
operations in Mole, remember that "res://" is the resource path, and no
