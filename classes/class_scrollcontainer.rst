...
+--------------------------+--------------------------------------------------------------------------------------------------------------------+
| :ref:`int<class_int>`    | :ref:`get_deadzone<class_ScrollContainer_get_deadzone>`  **(** **)** const                                         |
+--------------------------+--------------------------------------------------------------------------------------------------------------------+
...
+--------------------------+--------------------------------------------------------------------------------------------------------------------+
| void                     | :ref:`set_deadzone<class_ScrollContainer_set_deadzone>`  **(** :ref:`int<class_int>` deadzone  **)**               |
+--------------------------+--------------------------------------------------------------------------------------------------------------------+
...
.. _class_ScrollContainer_get_deadzone:

- :ref:`int<class_int>`  **get_deadzone**  **(** **)** const
...
.. _class_ScrollContainer_set_deadzone:

- void  **set_deadzone**  **(** :ref:`int<class_int>` deadzone  **)**
