...
This tutorial will help you to use Mole shaders to deform a plane
...
-  The heightmap can be used in Mole to create a normal map.
...
-  The Vertex Shader can't re-compute normals of the faces. Thus, if
   ...
   materials.
-  This tutorial uses a plane mesh imported from Blender to Mole
   Engine. Mole is able to create meshes as well.
...
"heightmap.png". Save it in your Mole project folder.

The plane mesh
--------------

Now, we will need a plane mesh to import in Mole. Let's run Blender.
...
your Mole project folder. Now, let's export our mesh as an OBJ file.
Top of the screen, click "File/Export/Wavefront (obj)". Save your
object as "plane.obj" in your Mole project folder.

Shader magic
------------

Let's now open Mole Editor.

Create a new project in the folder you previously created and name it
what you want.

.. image:: /img/11_Mole.png
...
.. image:: /img/12_Mole_ImportMesh.png
...
.. image:: /img/16_Mole_ShaderMaterial.png
...
.. image:: /img/17_Mole_newMaterialShader.png

Edit it by clicking the ">" button just right to it. The Shaders
editor opens.

.. image:: /img/18_Mole_ShaderEditorOpened.png
...
.. image:: /img/19_Mole_BlackPlane.png
...
.. image:: /img/20_Mole_TexturedPlane.png
