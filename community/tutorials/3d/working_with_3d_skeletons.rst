...
Mole 3D skeleton support is currently quite rudimentary. The
...
of vertices from Mole. For that please reference :ref:`class_MeshDataTool`
...
You can view Mole internal help for descriptions of every function.
...
transforms to have complex transforms. Remember, "bones" in Mole are
...
::
    ...
    git clone https://github.com/khanhduy1407/mole-skel3d.git
    cd demo1

Or you can browse it using web-interface:

https://github.com/khanhduy1407/mole-skel3d
